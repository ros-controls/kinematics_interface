...
namespace kinematics_interface_kdl {
  ...
  public:
    ...
    bool convert_cartesian_deltas_to_joint_deltas(
            const Eigen::Matrix<double, Eigen::Dynamic, 1> &joint_pos, const Eigen::Matrix<double, 6, 1> &delta_x_vec,
            const std::string &link_name, Eigen::Matrix<double, Eigen::Dynamic, 1> &delta_theta_vec) override;
    ...
    bool convert_joint_deltas_to_cartesian_deltas(
            const Eigen::Matrix<double, Eigen::Dynamic, 1> &joint_pos, const Eigen::Matrix<double, Eigen::Dynamic, 1> &delta_theta_vec,
            const std::string &link_name, Eigen::Matrix<double, 6, 1> &delta_x_vec) override;
    ...
    bool calculate_link_transform(
            ...
            Eigen::Matrix<double, 4, 4> &transform_vec) override;
